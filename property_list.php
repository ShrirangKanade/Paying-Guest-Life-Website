...
$user_property = mysqli_fetch_all($result_3, MYSQLI_ASSOC);
?>
                ...
                <div class="content-container col-md-8">
                    <div class="row no-gutters justify-content-between">
                        ...
                        <div class="interested-container">
                            ...
                            $is_interested = false;
                            foreach ($user_property as $u_p) {
                                if ($u_p['property_id'] == $property['p_id']) {
                                    $interested_users_count++;

                                    if ($u_p['user_id'] == $user_id) {
                                        $is_interested = true;
                                    }
                                }
                            }
                    ...
                    <div class="detail-container">
                        ...
                        <div class="property-gender">
                            <?php
                            if ($property['p_gender'] == "male") {
                            ?>
                                <img src="img/male.png" />
                            <?php
                            } elseif ($property['p_gender'] == "female") {
                            ?>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="button-container col-6">
                            <a href="property_detail.php?property_id=<?= $property['p_id'] ?>" class="btn btn-primary">View</a>
                        </div>
                    </div>
                </div>
            </div>
